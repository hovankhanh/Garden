                    ...
                    <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                        <div class="pull-right left-acc clearfix">
                            ...
                            <div class="top-search">
                                <form class="search-form form-inline" method="post" action="timkiem.php">
                ...
                <div class="wrapper">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                       <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a class="dropdown-toggle" data-toggle="dropdown" >Sản phẩm <span class="caret"></span></a>
                            ...
                            <li><a href="hethongcuahang.php">Hệ thống cửa hàng</a></li>    
                        </ul>
